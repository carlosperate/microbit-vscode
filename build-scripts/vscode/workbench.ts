/**
 * Adapted from Felix-B/vscode-web (MIT)
 * https://github.com/Felx-B/vscode-web/blob/1.92.0/workbench.ts
 *
 * Replaces src/vs/code/browser/workbench/workbench.ts in the upstream
 * microsoft/vscode tree with a minimal embedder bootstrap. Strips
 * secret-storage / URL-callback / auth / workspace-from-URL handling
 * that our static deployment cannot support.
 */
